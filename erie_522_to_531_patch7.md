...
Since you are using a private container registry, you must mirror the updated images from the IBM® Entitled Registry to your private container registry at ``.
...
- **Registry permissions**
  - Permission to access the private image registry at `` for pushing or pulling images
...
Update the cpd-cli utility to the latest version. For detailed documentation and instructions, see [Update the cpd-cli utility](https://www.ibm.com/docs/en/software-hub/5.3.x?topic=workstations-updating-software-hub-cli).
